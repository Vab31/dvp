        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500">
              ...
              Understanding the experiences of marginalised communities is crucial to fostering a more empathetic and just world.
          ...
          <div className="flex flex-wrap -m-3 justify-center">
            {/* Card 1 */}
            <div className="p-3 lg:w-1/3 sm:w-1/2 w-full flex flex-col">
              <div className="bg-gray-200 border-2 shadow-2xl p-6 rounded-lg flex flex-col items-center text-center h-full w-full">
                ...
                <div className="flex-grow flex flex-col justify-start">
                  ...
                  <p className="leading-relaxed text-base">
                    Amplifying marginalised community voices educates the public on the realities of inequality and exclusion.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-3 lg:w-1/3 sm:w-1/2 w-full flex flex-col">
              <div className="bg-gray-200 border-2 shadow-2xl p-6 rounded-lg flex flex-col items-center text-center h-full w-full">
                ...
                <div className="flex-grow flex flex-col justify-start">
                  ...
                  <p className="leading-relaxed text-base">
                    Connecting individuals to support marginalised communities.
                  </p>
                </div>
              </div>
            </div>
