...
const HeroSlider = () => {
  const slides = [
    { src: '/images/slide1.jpeg', text: 'Lived Realities, Shared Humanity — A Lens Into Displacement and Hope' },
    { src: '/images/slide2.jpeg', text: 'From Struggle to Strength — Documenting Resilience in Vulnerable Communities' },
    { src: '/images/slide3.jpeg', text: 'Stories Beyond Borders — Voices That Moved the World' },
  ];
